    ...
    def check_and_update_config(cls, vllm_config: VllmConfig) -> None:
        ...
        if cache_config:
            ...
            if not cache_config.enable_prefix_caching:
                ...
                cache_config.block_size = int(qaic_config.get("max_seq_len_to_capture")
                                              or qaic_config.get("prefill_seq_len")
                                              or vllm_config.model_config.max_model_len)

        qaic_config = vllm_config.additional_config if isinstance(vllm_config.additional_config, dict) else {}

        on_device_sampling_en = qaic_config.get('aic_include_sampler', False)
        ...
        if "disable_multimodal" in qaic_config:
            val = qaic_config["disable_multimodal"]
