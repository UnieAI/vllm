...
class MllamaQaicMultiModalProcessor(BaseMultiModalProcessor[MllamaProcessingInfo]):
    def __init__(self, *args, **kwargs):
        ...
        _qaic_cfg = self.info.ctx.model_config.__dict__.get("_qaic_cfg_cache") or {}
        try:
            from vllm.platforms import current_platform
            _qaic_cfg = getattr(current_platform, '_last_vllm_config_additional', {}) or {}
        except Exception:
            pass
        is_kv_offload = _qaic_cfg.get("kv_offload", False)
