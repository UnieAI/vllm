...
class QaicWorker(WorkerBase):
    ...
    def init_device(self) -> None:
        ...
        qaic_cfg = self.vllm_config.additional_config if isinstance(
            self.vllm_config.additional_config, dict) else {}
        device_group = qaic_cfg.get("device_group", None)
...
def init_qaic_worker_distributed_environment(
    ...
    # Note: ensure_kv_transfer_initialized requires kv_cache_config in v0.21+
    # It will be called during initialize_cache if needed
