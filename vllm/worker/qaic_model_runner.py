...
try:
    from vllm.model_executor.layers.sampler import SamplerOutput, get_sampler, Sampler
except ImportError:
...
class QaicModelRunner(ModelRunnerBase[ModelInputForQaic]):
    ...
    def _prepare_prompt(
        ...
        max_padding = None
        max_seq_len = int((self.vllm_config.additional_config or {}).get("max_seq_len_to_capture")
