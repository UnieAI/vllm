...
# Temporarily adding PR #22386 [gpt-oss] tool parser supports for /chat/completions [1/n] and a subsequent fix from PR #24409 [gpt-oss][Responses API] Fix the function call id format
# for adding openai parser and function calling support from vLLM r0.10.2
