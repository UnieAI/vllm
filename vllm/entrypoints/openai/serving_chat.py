...
class OpenAIServingChat(OpenAIServing):
    ...
    async def chat_completion_full_generator(
        ...
        for output in final_res.outputs:
            ...
            if self.use_harmony:
                # [gpt-oss] fix non-tool calling path for chat completion
                # https://github.com/vllm-project/vllm/pull/24324/changes 
        ...
        usage = UsageInfo(prompt_tokens=num_prompt_tokens,
                          ...
                          ttft_excluding_queue_wait_time_in_ms=(final_res.metrics.first_token_time - final_res.metrics.first_scheduled_time) / final_res.metrics.prefill_batch_size * 1000,
                          e2e_inference_in_ms=(final_res.metrics.finished_time - final_res.metrics.arrival_time)*1000,
                          queue_wait_time_in_ms=(final_res.metrics.first_scheduled_time - final_res.metrics.arrival_time)*1000,
                          )
        usage.ttft_in_ms = usage.ttft_excluding_queue_wait_time_in_ms + usage.queue_wait_time_in_ms
