...
CUDA_VISIBLE_DEVICES=1 vllm serve /models/Qwen/Qwen3-8B \
  ...
  --dtype float16 \
  --async-scheduling \
  --speculative-config '{"method":"ngram_dsc","num_speculative_tokens":4,"draft_tensor_parallel_size":1,"prompt_lookup_min":3,"prompt_lookup_max":8}' 2>&1 | tee dsc.log
