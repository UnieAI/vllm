...
series = {
    '0529_kv_fp16': {
        ...
        'throughput': [],
        'c': [],
        'label': '0529 KV FP16 (vLLM v0.10.1.2)',
        'color': '#444d56',
        'marker': 'o',
        'ls': '-',
    },
    '0529_kv_fp8': {
        ...
        'throughput': [],
        'c': [],
        'label': '0529 KV FP8/MXINT8 (vLLM v0.10.1.2)',
        'color': '#00a3ff',
        'marker': 'D',
        'ls': '-',
    },
    '0602_kv_fp16': {
        'folder': './0602/kv_fp16_no_ngram',
        'ttft': [],
        'throughput': [],
        'c': [],
        'label': '0602 KV FP16 (vLLM v0.20)',
        'color': '#8b5cf6',
        'marker': 's',
        'ls': '--',
    },
...
# Load data from 0529 and 0602 KV cache folders.
...
plt.tight_layout()
output_path = './0602/comparison_0529_0602_kv_fp16_fp8_no_ngram_premium.png'
